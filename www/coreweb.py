        ...
        if self._has_var_kw_arg or self._has_named_kw_args or self._requested_kw_args:
            if request.method == 'POST':
                ...
                if ct.startswith('application/json'):
                    ...
                    logger.info(f'form post data:{params}')
                    kw = dict(**params)
                else:
...
def add_static(app):
    ...
    app.router.add_static('/yaya-huiben/', os.path.join(os.path.dirname(os.path.abspath(__file__)), 'yaya-huiben'))
    app.router.add_static('/xmly-huiben/', os.path.join(os.path.dirname(os.path.abspath(__file__)), 'xmly-huiben'))
